<html><head>   <link rel='stylesheet' href='../style.css' >  <link rel='stylesheet' href='../style.php' >
  ...
  <meta name="keywords" content="HTML, CSS,PHP,Arno Schmidt Etym Generator, schmidtisator, arnoschmidtisator, arnoschmidtator, verlispeln, verlispelung, etym, etyms, zettels traum, erotik">
...
<!--span class="frac"-->
	<div id="box">
		...
		<hr class="new1">
	<form method="get" action="../schmidtinatorfunktioniertregex2.php">
<!-- onclick="this.value=''" // ggf einfuegen unten -->
<Textarea  onclick="this.value=null;"  type="text" name="str" rows="6" cols="35"
...
Echo "<br>";
Echo "<hr class='new1'>";
Echo "Ihre Eingabe zum Korrigieren und Kopieren: <br><br>".nl2br($str);
echo "<br>";
/*echo $pattern;
...
<?php echo "In html f&uuml;r Sie: <textarea>".nl2br(preg_replace($pattern, $sing, $str))."</textarea> mit <a href='../style.css'>style.css</a>";
Echo "<br>";?>
	<?php
$filepath ="ator.txt";
...
<p style="color:#fff5ee;align:center;">&copy; <span style='vertical-align:-10px;'><span class='frac'><sup>Kl</sup><span> / </span><sub>L</sub></span></span>aus <span style='vertical-align:-10px;'><span class='frac'><sup>Wul</sup><span> / </span><sub>Vul</sub></span><span class='frac'><sup>ff</sup><span> / </span><sub>v</sub></span></span>&#9;2009&mdash;<?php 
echo date("Y");
?>.</p>
