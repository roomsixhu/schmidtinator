...
<Textarea  onfocus="this.value=null;"  type="text" name="str" rows="6" cols="35" style="background-color:#29220a; color:#fff5ee;"
...
aaa / bbb 
ccc / ddd</textarea><br>
	<label>Ausrichten&nbsp;!!!&nbsp;</label><input type ="number" step="1" name ="ausr" value="-14" style="background-color:#fff5ee;" widht="4"> 
<br>
<input type="radio" name="brch" value="frac" checked="true"><label>&nbsp;Stahlberg</label>
<input type="radio" name="brch" value="uml"><label>&nbsp;Haffmans</label>
<!--input type="radio" name="gender" value="other">Other-->
<br>
	
<input type="submit" src="button.png" value="Sp &uuml; / ie len ! -- > -.- ),">
</form>
<script>
...
# $ausr = $ausr;
if ($brch == "frac"){
$sing ="<span style='vertical-align:$ausr\px'><span class='frac'><sup>$1</sup><span> / </span><sub>$2</sub></span></span>";
Echo "<br>";}
if ($brch == "uml") {
$ausr = $ausr +10;
$sing ="<span style='vertical-align: $ausr\px;'><span class='$brch'><sup>$1</sup><span> / </span><sub>$2</sub></span></span>";
Echo "<br>";}
...
<?php echo "In html f&uuml;r Sie: <textarea style='background-color:#fff5ee;'>".nl2br(preg_replace($pattern, $sing, $str))."</textarea> mit <a href='style.css'>style.css</a>";
Echo "<br>";?>
	<?php
$filepath ="ator.txt";
